...
import 'package:ecommere_course/data/datasource/remote/home_data.dart';
  ...
  getdata() async {
    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        ...
        titlehometext = settings[0]["settings_titlehome"];
        bodyhometext = settings[0]["settings_bodyhome"];
